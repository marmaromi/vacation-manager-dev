...
function AddVacation(): JSX.Element {
    ...
    function validatePost(vacation: VacationModel): void {
        const result = VacationModel.vacationPostValidationSchema.validate(vacation);        
    ...
    return (
        <div className="AddVacation Box">
            ...
            <form onSubmit={handleSubmit(send)}>
                ...
                <textarea rows={4} cols={20}  {...register("description")} ></textarea>
